...
public class PacketListNBT {
   ...
   public static PacketListNBT decode(PacketBuffer buf) {
      String names = buf.func_150789_c(32767);
      int x = buf.readInt();
      int y = buf.readInt();
      int z = buf.readInt();
      boolean isBlock2x2 = buf.readBoolean();
      String addrem = buf.func_150789_c(32767);
      ...
      ((NetworkEvent.Context)ctx.get()).enqueueWork(() -> {
         ...
         if (packet.addrem.equals("add")) {
            if (packet.isBlock2x2) {
               TileEntityBlockVault2by2 te = (TileEntityBlockVault2by2)worldIn.func_175625_s(new BlockPos(packet.x, packet.y, packet.z));
               if (te != null) {
               ...
               TileEntityBlockVault te = (TileEntityBlockVault)worldIn.func_175625_s(new BlockPos(packet.x, packet.y, packet.z));
               if (te != null) {
                  te.func_70296_d();
               }
            }
