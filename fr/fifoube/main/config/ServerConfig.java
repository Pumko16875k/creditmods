...
public class ServerConfig {
   ...
   ServerConfig(ForgeConfigSpec.Builder builder) {
      ...
      this.plotBorderBlock = builder.comment("Define the block use to create the edges of the plot.").translation("text.economyinc.config.edgeplot").define("plotBorderBlock", "minecraft:smooth_stone_slab");
      this.goldChangerDuration = builder.comment("Change the time it takes for the gold changed to process.").translation("text.economyinc.config.goldchangerduration").defineInRange("goldChangerDuration", 356, 0, 5000);
      this.cooldownSeller = builder.comment("Cooldown applied for the seller, prevent fast buy.").translation("text.economyinc.config.sellercooldown").defineInRange("cooldownSeller", 20, 20, 500);
      builder.pop();
   }
}
